...
export default async function RSVPPage({ searchParams }: { searchParams: Promise<{ invite?: string }> }) {
  ...
  return <main className="page-main"><p className="eyebrow">{settings.coupleDisplayName}</p><h1>RSVP</h1><p>Please reply for everyone listed on your invitation.</p><RSVPFlow initialCode={invite} /></main>
}
